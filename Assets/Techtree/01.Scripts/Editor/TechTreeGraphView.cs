...
namespace TechTree
{
    ...
    public partial class TechTreeGraphView : GraphView
    {
        ...
        public TechTreeGraphView()
        {
            ...
            var styleSheet = AssetDatabase.LoadAssetAtPath<StyleSheet>("Assets/Techtree/01.Scripts/Editor/TechTreeGenerator.uss");
        ...
        public override void BuildContextualMenu(ContextualMenuPopulateEvent evt)
        {
...

            {
                ...
                foreach (var t in types)
                {
                    ...
                    evt.menu.AppendAction($"[{t.BaseType.Name}] {t.Name}", (a) => CreateNode(t, mousePosition));
                }
